...
public class PlayerController : MonoBehaviour
{
    ...
    //default color. cached to switch btwn colors
    ...
    private void Awake()
    {
        ...
        for (int i = 0; i < m_Attacks.Length; i++){
            ...
            {
                Debug.LogError(attack.AttackName + " has a wind up time that is larger the the amount of time that the player if frozen for");
            }
        }
    }
    ...
    private void Update()
    {
        ...
        //set how hard player is pressing buttons
