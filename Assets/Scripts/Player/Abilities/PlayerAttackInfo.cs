...
public class PlayerAttackInfo
{
    ...
    [SerializeField]
    [Tooltip("The trigger string to use to acrivate this attack in the animator")]
    ...
    [SerializeField]
    [Tooltip("The prefab of the game obkect representing the ability")]
    ...
    [SerializeField]
    [Tooltip("Where to spawn the ability game ovject with respect to the player")]
